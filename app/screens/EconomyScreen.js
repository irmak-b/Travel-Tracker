...
const CAROUSEL_DATA = [
  { id: "1", emoji: "📰", text: "25 Road Journal per Continent!" },
  { id: "2", emoji: "📒", text: "Add up to 5 photos!" },
...
export default function EconomyScreen() {
  ...
  try {
    ...
    Alert.alert(
      "Success",
      "Economy Pack purchase simulated!\nPlan ID 'eco' has been saved."
      [{ text: "OK" }]
    );
  } catch (err) {
    ...
    >
      ...
      <SafeAreaView style={styles.contentContainer}>
        <View style={styles.headerContainer}>
          <Text style={styles.headerTitle}>Economy Pack</Text>
          <Text style={styles.headerSubtitle}>"Budget-friendly choice"</Text>
        </View>
        ...
        <View style={styles.productCard}>
          ...
          <Text style={styles.priceText}>
            {paywall?.products?.[0]?.localizedPrice || "$9.99/year"}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  productCard: { backgroundColor: "#b3742883", width: width * 0.85, paddingVertical: 18, alignItems: "center", borderRadius: 19 },
